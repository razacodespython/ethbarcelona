...
import GnosisSafeProxyFactoryWeb3Contract, { CreateProxyProps } from './contracts/GnosisSafeProxyFactory/GnosisSafeProxyFactoryWeb3Contract';
...
export { Web3Adapter, Web3AdapterConfig, Web3TransactionOptions, CreateProxyProps, Web3TransactionResult, CreateCallWeb3Contract, GnosisSafeContractWeb3, GnosisSafeProxyFactoryWeb3Contract, MultiSendWeb3Contract, MultiSendCallOnlyWeb3Contract, SignMessageLibWeb3Contract };
